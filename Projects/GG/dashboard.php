...
// Headcount query including current user
$countSql = "SELECT COUNT(*) FROM GG_users";
$countStmt = $conn->prepare($countSql);
$countStmt->execute();
$countStmt->bind_result($memberCount);
$countStmt->fetch();
$countStmt->close();
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <?php include 'user_side_event.php'; ?>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            GG Members (<?= $memberCount ?>)
                        </div>
                        <div class="card-body">
                            <?php include 'user_member.php'; ?>
                        </div>
                    </div>
                </div>
            </div>
